(function() {
    ...
    window.rgbKineticSlider = function(options) {
        ...
        window.slideTransition = function slideTransition(next) {

            // Samuelbassett.xyz -> add
            dispSprite.rotation =  options.transitionSpriteRotation += 10
            ...
            // if subtitles inactive and title active
                ...
                timelineTransition
                    .to(dispFilter.scale, options.slideTransitionDuration , {
                        x: scaleAmp,
                        y: scaleAmp,
                        // Samuelbassett.xyz -> changed from ease: Power2.easeIn
