...
let transition = {type: "spring", stiffness: 300, duration: 0}
...
export default function Component ({ data, index, hasSubmitted }) {
    ...
    let getXPosition = (square) => {
        ...
        if(dragElX > squareX) {
            return - (dragElX - squareX + dragElWidth / 2 - squareWidth / 2)
        } else {
            return squareX - dragElX - dragElWidth / 2 + squareWidth / 2;
        }
    }
