...
export const pageProgrammeAndPageTemplateSlugsQuery = `
*[_type in ["pageProgramme", "pageTemplate"]] {
  language,
  "slug": slug.current
}
`
...
export const pageProgrammeAndPageTemplateBySlugQuery = `
*[_type in ["pageProgramme", "pageTemplate"] && slug.current == $slug][0] {
  _type,
  ${pageTemplateFields, pageProgrammeFields}
}
`
