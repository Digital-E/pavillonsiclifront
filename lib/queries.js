...
const rencontreDeLurbanismeFields = `
  _id,
  referenceTitle,
  title,
  description,
...
export const rencontreDeLurbanismeSlugsQuery = `
*[_type == "rencontreDeLurbanisme"] {
  language,
  "slug": slug.current
}
`

export const rencontreDeLurbanismeBySlugQuery = `
*[_type == "rencontreDeLurbanisme" && slug.current == $slug][0] {
  ${rencontreDeLurbanismeFields}
}
`
